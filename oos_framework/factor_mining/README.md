...
- **样本外策略回测**（top-30% 每日再平衡，毛收益）：区间 2021-10~2025-10 约 3.85 年，**年化 +21.7%**、总收益 +112.6%、夏普 0.92，显著跑赢全市场等权基准（年化 +11.7%）。
  注：严格样本外只覆盖 WFA 的 OOS 窗（首 3 年为训练窗，不计入），故实盘信号覆盖约 4 年；年化率按年折算。若需覆盖更长区间，需更早的训练数据（数据湖自 2018-07 起）。
